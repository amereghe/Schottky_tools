...
intTime = [20,200,20000]*10^-6; %integration time
...
TB1=fft(tb1);
tb2=generate(fs,t3,q,friv,w,taus,1,a);
TB2=fft(tb2);
...
T=(lu);
F=(LU);
[T,F]=padding(T,F,lu1,lu2,LU1,LU2);

%plotTimesFreqfig(T,F,friv);
newPlotTimesFreqfig(t,f,T,F,friv);
legend('20us','200us','20ms');
title('Longitudinal unbunched');
